...
"use strict";function SolidResponse(e,t){if(!e)return this.xhr=null,this.user="",this.method=null,this.types=[],void(this.graph=null);var s=e.getResponseHeader("Link");this.linkHeaders=webUtil.parseLinkHeader(s)||{},t=t?t.toLowerCase():"",this.method=t,this.acl=this.linkHeaders.acl,this.acl&&(this.acl=this.acl[0]),this.allowedMethods=this.parseAllowedMethods(e,t),this.graph=null,this.meta=this.linkHeaders.meta||this.linkHeaders.describedBy,this.meta&&(this.meta=this.meta[0]),this.types=this.linkHeaders.type||[],this.url=e.getResponseHeader("Location")||e.responseURL,this.user=e.getResponseHeader("User")||"",this.websocket=e.getResponseHeader("Updates-Via")||"",this.xhr=e}module.exports=SolidResponse;var webUtil=require("../util/web-util"),graphUtil=require("../util/graph-util");SolidResponse.prototype.contentType=function(){return this.xhr?this.xhr.getResponseHeader("Content-Type"):null},SolidResponse.prototype.exists=function(){return this.xhr&&this.xhr.status>=200&&this.xhr.status<400},SolidResponse.prototype.isContainer=function(){return this.isType("http://www.w3.org/ns/ldp#Container")},SolidResponse.prototype.isLoggedIn=function(){return this.user},SolidResponse.prototype.isType=function(e){return-1!==this.types.indexOf(e)},SolidResponse.prototype.parseAllowedMethods=function(e,t){return"get"===t?{}:webUtil.parseAllowedMethods(e.getResponseHeader("Allow"),e.getResponseHeader("Accept-Patch"))},SolidResponse.prototype.parsedGraph=function(){return this.graph||(this.graph=graphUtil.parseGraph(this.url,this.raw(),this.contentType())),this.graph},SolidResponse.prototype.raw=function(){return this.xhr?this.xhr.response:null};
